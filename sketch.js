...
function draw(){
    ...
    Engine.update(engine);
      ...
      textSize(45);
      fill("red");
      text("Bruce Wayne; BATMAN", 600,200);
      ...
      textSize(45);
      fill("white");
      text("View of a dark rainy night on the streets of Gotham on the ", 600,250);
      text("infamous night that he lost his beloved parents.", 600, 300)
